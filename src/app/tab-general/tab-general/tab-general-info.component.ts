...
export class TabGeneralInfoComponent extends CoreBase implements OnInit {
  ...
  constructor(private generalInfoWebService: GeneralInfoWebService, private dataForTabHeaderService: DataForTabHeaderService) {
  ...
  cunoHeaderMethod() {    // méthode observable pour récupérer la CUNO de la dropdown du header
    this.dataForTabHeaderService.cunoSubject.subscribe(
      (data: any) => {
