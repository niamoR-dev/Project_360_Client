...
export class TabCustomerReturnsComponent extends CoreBase implements OnInit {
   ...
   constructor(private customersReturnsWebService: CustomersReturnsWebService, private cunoHeaderService: CunoHeaderService, private whloHeaderService: WhloHeaderService) {
   ...
   whloHeaderMethod(){
      this.whloSubscription = this.cunoHeaderService.whloSubject.subscribe(
         (data : any) => {
