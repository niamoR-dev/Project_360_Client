...
export class AssortmentWebService {


  // appel API pour affichage des assortiments par client : Lst360CusAssCli
  // Appel API pour l'affichage des articles par assortiments Lst360CusAssArt
